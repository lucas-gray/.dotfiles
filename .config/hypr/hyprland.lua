...
hl.on('hyprland.start', function()
  ...
  hl.exec_cmd 'swaybg -i ~/Wallpapers/wallpaper.png'
...
hl.config {
  general = {
    ...
    col = {
      active_border = { colors = { rose, pine, love, iris }, angle = 90 },
...
hl.config {
  input = {
    ...
    kb_variant = '',
    kb_model = '',
    kb_options = 'ctrl:nocaps', -- Bind caps to ctrl
    kb_rules = '',
